...
def main():
    ...
    parser.add_argument(
        "--user-id", default="test-user-123", help="User ID to include in token"
    )
    parser.add_argument(
        "--username", default="testuser", help="Username to include in token"
    )
    parser.add_argument(
        "--email", default="test@example.com", help="Email to include in token"
    )
